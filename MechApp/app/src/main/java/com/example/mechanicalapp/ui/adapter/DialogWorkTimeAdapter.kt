...
class DialogWorkTimeAdapter  (var mContext: Context, var mList:MutableList<CodeData>, var mOnItemClickListener: OnItemClickListener): RecyclerView.Adapter<RecyclerView.ViewHolder>(){
