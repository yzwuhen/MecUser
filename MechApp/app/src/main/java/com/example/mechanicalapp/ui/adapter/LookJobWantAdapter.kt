...
import kotlinx.android.synthetic.main.item_look_job_want.view.*


class LookJobWantAdapter  (var mContext: Context, var mList:MutableList<RecruitData>, var mOnItemClickListener: OnItemClickListener): RecyclerView.Adapter<RecyclerView.ViewHolder>() {
