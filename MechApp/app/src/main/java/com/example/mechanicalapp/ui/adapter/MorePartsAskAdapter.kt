...
class MorePartsAskAdapter (
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return MorePartsAskVh(
            LayoutInflater.from(mContext).inflate(R.layout.item_more_parts_ask, parent, false),
    ...
    class MorePartsAskVh(itemView: View, mOnItemClickListener: OnItemClickListener) :
