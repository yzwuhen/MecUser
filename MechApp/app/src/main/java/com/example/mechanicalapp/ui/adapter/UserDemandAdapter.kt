...
class UserDemandAdapter(var mContext:Context, var mList:MutableList<MecRentOutData>, var type:Int, var mOnItemClickListener: OnItemClickListener): RecyclerView.Adapter<RecyclerView.ViewHolder>() {
