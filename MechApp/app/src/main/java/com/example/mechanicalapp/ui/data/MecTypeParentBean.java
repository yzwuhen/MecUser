...
public class MecTypeParentBean extends NetData {
    ...
    public static class ResultBean {
        ...
        private int pages;
        private List<MecTypeParentData> records;
        ...
        public List<MecTypeParentData> getRecords() {
            return records;
        }

        public void setRecords(List<MecTypeParentData> records) {
