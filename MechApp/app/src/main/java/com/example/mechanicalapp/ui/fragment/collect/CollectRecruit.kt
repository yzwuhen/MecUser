...
class CollectRecruit : BaseCusFragment(), OnItemClickListener, CollectView<RecruitData>,
    ...
    override fun initView() {
        ...
        spring_list.setListener(object : SpringView.OnFreshListener {
            override fun onRefresh() {
                ...
                (mPresenter as PresenterImpl).getRecruitCollect(1)
            }

            override fun onLoadmore() {
                (mPresenter as PresenterImpl).getRecruitCollectMore(1)
            }
        })
