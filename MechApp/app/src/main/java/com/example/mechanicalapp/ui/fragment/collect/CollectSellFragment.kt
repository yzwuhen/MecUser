...
import com.example.mechanicalapp.ui.adapter.CollectSellAdapter
...
class CollectSellFragment : BaseCusFragment(), OnItemClickListener,View.OnClickListener,
    CollectView<MecSellData> {


    private var mAdapter: CollectSellAdapter? = null
    ...
    override fun initView() {
        super.initView()
        mAdapter = CollectSellAdapter(mContext, mLeaseList, this)
        ...
        spring_list.setListener(object : SpringView.OnFreshListener {
            override fun onRefresh() {
                ...
                (mPresenter as PresenterImpl).getCollectSecondHandList(1)
            }

            override fun onLoadmore() {
                (mPresenter as PresenterImpl).getCollectSecondHandListMore(1)
            }
        })
