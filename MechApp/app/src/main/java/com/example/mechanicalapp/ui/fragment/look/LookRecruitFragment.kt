...
class LookRecruitFragment : BaseFragment<NetData>(), View.OnClickListener,ViewPager.OnPageChangeListener {
    ...
    init {
        mFragmentList?.add(LookRecruit())
        mFragmentList?.add(LookJobWant())
    }
