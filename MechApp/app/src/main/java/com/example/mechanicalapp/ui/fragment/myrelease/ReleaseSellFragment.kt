...
class ReleaseSellFragment  : BaseCusFragment(), OnItemClickListener, PopUtils.onViewListener,
    View.OnClickListener,MyReleaseView<MecSellData> {


    private var mAdapter: ReleaseSellAdapter? = null
    ...
    override fun initView() {
        super.initView()
        mAdapter = ReleaseSellAdapter(mContext, mList, this)
        ...
        spring_list.setListener(object : SpringView.OnFreshListener {
            override fun onRefresh() {
                ...
                (mPresenter as MyReleasePresenterImpl).getMyBusinessSellList(1)
            }
