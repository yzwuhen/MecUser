...
class SearchMecLeaseFragment(var title:String?) : BaseCusFragment() , View.OnClickListener, ViewPager.OnPageChangeListener  {
    ...
    init {
        mFragmentList?.add(SearchMecLease(title))
        mFragmentList?.add(SearchMecAsk(title))
    }
