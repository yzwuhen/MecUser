...
class SearchRecruitFragment(var title:String?): BaseCusFragment() , View.OnClickListener, ViewPager.OnPageChangeListener  {
    ...
    init {
        mFragmentList?.add(SearchRecruit(title))
        mFragmentList?.add(SearchJobWant(title))
    }
