...
class StoreModelImpl : BaseModel {
    ...
    fun getStoreData(mISubscriberListener: ISubscriberListener<StoreBean>) {

        appsService?.getStoreData()
            ?.subscribeOn(Schedulers.io())?.unsubscribeOn(Schedulers.io())?.observeOn(
                AndroidSchedulers.mainThread()
            )?.subscribe(NetSubscribe<StoreBean>(mISubscriberListener))
