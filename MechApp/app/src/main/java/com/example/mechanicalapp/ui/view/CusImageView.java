...
/**
 * Created by yz_wuhen on 2017/8/24.
 *
 * 自定义ImageView
 */
public class CusImageView extends AppCompatImageView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.CusImageView);
            borderColor = array.getColor(R.styleable.CusImageView_border_color, borderColor);
            borderWidth = array.getDimensionPixelOffset(R.styleable.CusImageView_border_width, borderWidth);
            pressAlpha = array.getInteger(R.styleable.CusImageView_press_alpha, pressAlpha);
            pressColor = array.getColor(R.styleable.CusImageView_press_color, pressColor);
            radius = array.getDimensionPixelOffset(R.styleable.CusImageView_radius, radius);
            shapeType = array.getInteger(R.styleable.CusImageView_shape_type, shapeType);
            array.recycle();
        }
...
//                | Canvas.CLIP_TO_LAYER_SAVE_FLAG;
    ...
    private void drawPress(Canvas canvas) {
        // check_norl is rectangle or circle
        if (shapeType == 1) {
